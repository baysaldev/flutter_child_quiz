...
import 'package:flutter_child_quiz/Data/data6.dart';
import 'package:flutter_child_quiz/Model/question_model6.dart';
...
class _MeyvelerState extends State<Meyveler>
  ...
  List<QuestionModel6> questions6 = <QuestionModel6>[];
  int index = 0;
  int points = 0;
  int correct = 0;
  int incorrect = 0;
          ...
          Navigator.pushReplacement(
              ...
              MaterialPageRoute(
                  builder: (context) => Result1(
                        score: points,
                        totalQuestion: questions6.length,
                        correct: correct,
                        incorrect: incorrect,
                      )));
        }
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            CachedNetworkImage(
              imageUrl: questions6[index].getImageUrl6()!,
            ),
            Spacer(),
            Container(
              padding: EdgeInsets.symmetric(horizontal: 30),
              child: Row(
                ...
                children: <Widget>[
                  Expanded(
                    ...
                    onTap: () {
                      print(questions6[index].getAnswwer6());
                      questions6.forEach((element) {
                        print(element.toString());
                      });
                      if (questions6[index].getAnswwer6() == "Doğru") {
                        setState(() {
                          points = points + 10;
                  ...
                  Expanded(
                      child: GestureDetector(
                    onTap: () {
                      if (questions6[index].getAnswwer6() == "Yanlış") {
                        setState(() {
                          points = points + 10;
                          nextQuestion();
                          correct++;
